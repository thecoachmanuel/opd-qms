...
import { Save, AlertCircle, Check, Upload } from 'lucide-react';
import { uploadSiteLogo } from '../services/api';
                    ...
                    onChange={async (e) => {
                      ...
                      reader.onload = async () => {
                        ...
                        try {
                          ...
                          const resp = await uploadSiteLogo(dataUrl);
                          handleChange('header', 'logo_url', resp.logo_url);
